...
export default function Page({ params, searchParams }: { params: pageParam, searchParams: any }) {
    ...
    return (
        <div className='w-full h-full bg-gray-200 min-h-screen py-4 px-2'>
            ...
            <div className='w-full py-4 px-4 flex items-center justify-center'>
                {
                    isLoading ?
                        ...
                        :
                        <div className='lg:w-4/5 w-full h-full bg-gray-100 rounded-xl lg:h-4/5 items-center justify-center shadow-2xl  '>
                            <div className='grid grid-cols-2'>
                                ...
                                <div className='w-full px-3 h-full  rounded flex flex-col lg:px-5 py-2'>
